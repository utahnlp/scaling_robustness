...
#SBATCH --job-name=microsoft_deberta-v3-base_mrpc_2
#SBATCH --output=final_models//mrpc/microsoft/deberta-v3-base/seed-2/slurm_output.txt
#SBATCH --error=final_models//mrpc/microsoft/deberta-v3-base/seed-2/slurm_output.txt
