...
#SBATCH --job-name=microsoft_deberta-v3-base_pietrolesci/nli_fever_1
#SBATCH --output=final_models//pietrolesci/nli_fever/microsoft/deberta-v3-base/seed-1/slurm_output.txt
#SBATCH --error=final_models//pietrolesci/nli_fever/microsoft/deberta-v3-base/seed-1/slurm_output.txt
