...
#SBATCH --job-name=microsoft_deberta-v3-base_pietrolesci/nli_fever_3
#SBATCH --output=final_models//pietrolesci/nli_fever/microsoft/deberta-v3-base/seed-3/slurm_output.txt
#SBATCH --error=final_models//pietrolesci/nli_fever/microsoft/deberta-v3-base/seed-3/slurm_output.txt
