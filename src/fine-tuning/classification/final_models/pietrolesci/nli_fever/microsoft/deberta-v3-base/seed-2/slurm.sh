...
#SBATCH --job-name=microsoft_deberta-v3-base_pietrolesci/nli_fever_2
#SBATCH --output=final_models//pietrolesci/nli_fever/microsoft/deberta-v3-base/seed-2/slurm_output.txt
#SBATCH --error=final_models//pietrolesci/nli_fever/microsoft/deberta-v3-base/seed-2/slurm_output.txt
