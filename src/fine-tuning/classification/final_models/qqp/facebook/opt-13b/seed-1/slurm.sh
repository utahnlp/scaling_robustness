...
#SBATCH --job-name=facebook_opt-13b_qqp_1
#SBATCH --output=final_models//qqp/facebook/opt-13b/seed-1/slurm_output.txt
#SBATCH --error=final_models//qqp/facebook/opt-13b/seed-1/slurm_output.txt
