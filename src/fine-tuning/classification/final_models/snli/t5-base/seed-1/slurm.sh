...
#SBATCH --job-name=t5-base_snli_1
#SBATCH --output=final_models//snli/t5-base/seed-1/slurm_output.txt
#SBATCH --error=final_models//snli/t5-base/seed-1/slurm_output.txt
