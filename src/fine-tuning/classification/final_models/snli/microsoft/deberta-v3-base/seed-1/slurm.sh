...
#SBATCH --job-name=microsoft_deberta-v3-base_snli_1
#SBATCH --output=final_models//snli/microsoft/deberta-v3-base/seed-1/slurm_output.txt
#SBATCH --error=final_models//snli/microsoft/deberta-v3-base/seed-1/slurm_output.txt
