...
#SBATCH --job-name=t5-base_mnli_3
#SBATCH --output=final_models//mnli/t5-base/seed-3/slurm_output.txt
#SBATCH --error=final_models//mnli/t5-base/seed-3/slurm_output.txt
