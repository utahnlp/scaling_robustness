...
#SBATCH --job-name=microsoft_deberta-v3-base_mnli_3
#SBATCH --output=final_models//mnli/microsoft/deberta-v3-base/seed-3/slurm_output.txt
#SBATCH --error=final_models//mnli/microsoft/deberta-v3-base/seed-3/slurm_output.txt
