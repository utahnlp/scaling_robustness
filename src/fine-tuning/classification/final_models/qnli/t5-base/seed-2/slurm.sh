...
#SBATCH --job-name=t5-base_qnli_2
#SBATCH --output=final_models//qnli/t5-base/seed-2/slurm_output.txt
#SBATCH --error=final_models//qnli/t5-base/seed-2/slurm_output.txt
