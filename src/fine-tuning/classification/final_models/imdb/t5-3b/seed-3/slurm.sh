...
#SBATCH --job-name=t5-3b_imdb_3
#SBATCH --output=final_models//imdb/t5-3b/seed-3/slurm_output.txt
#SBATCH --error=final_models//imdb/t5-3b/seed-3/slurm_output.txt
...
echo "python t5_run_glue_trainer.py --model_name_or_path t5-3b --per_device_train_batch_size 2 --per_device_eval_batch_size 2 --num_train_epochs 3 --seed 3 --task_name imdb --do_train --save_steps 1000000 --max_source_length 512 --overwrite_output_dir --output_dir final_models//imdb/t5-3b/seed-3 --learning_rate 0.0001 --predict_with_generate --gradient_accumulation_steps 2"
