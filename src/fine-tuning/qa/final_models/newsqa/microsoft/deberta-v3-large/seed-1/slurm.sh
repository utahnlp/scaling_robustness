...
#SBATCH --job-name=microsoft_deberta-v3-large_newsqa_1
#SBATCH --output=final_models//newsqa/microsoft/deberta-v3-large/seed-1/slurm_output.txt
#SBATCH --error=final_models//newsqa/microsoft/deberta-v3-large/seed-1/slurm_output.txt
