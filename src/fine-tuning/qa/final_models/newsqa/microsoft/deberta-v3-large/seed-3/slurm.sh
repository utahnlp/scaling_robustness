...
#SBATCH --job-name=microsoft_deberta-v3-large_newsqa_3
#SBATCH --output=final_models//newsqa/microsoft/deberta-v3-large/seed-3/slurm_output.txt
#SBATCH --error=final_models//newsqa/microsoft/deberta-v3-large/seed-3/slurm_output.txt
