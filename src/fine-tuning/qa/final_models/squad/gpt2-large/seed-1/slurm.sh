...
#SBATCH --job-name=gpt2-large_squad_1
#SBATCH --output=final_models//squad/gpt2-large/seed-1/slurm_output.txt
#SBATCH --error=final_models//squad/gpt2-large/seed-1/slurm_output.txt
