...
FILE_NAME_TO_METRIC_DETAILS = {
        'robustness/fever_symmetric/fever_symmetric_v0.1_generated.jsonl': {'evaluation': 'fever-symmetric v1', 'gold_key': 'label', 'type': 'none', 'subset': 'none', 'metric': 'accuracy', 'pred_label_map': {'entailment': 'SUPPORTS', 'contradiction':'REFUTES', 'neutral': 'NOT ENOUGH INFO'} },
        'robustness/fever_symmetric/fever_symmetric_v0.2_test.jsonl': {'evaluation': 'fever-symmetric v2', 'gold_key': 'gold_label', 'type': 'none', 'subset': 'none', 'metric': 'accuracy', 'pred_label_map': {'entailment': 'SUPPORTS', 'contradiction':'REFUTES', 'neutral': 'NOT ENOUGH INFO'}},
        'robustness/fnc/fnc_test.csv': {'evaluation': 'fnc', 'gold_key': 'label', 'type': 'none', 'subset': 'none', 'metric': 'accuracy'},
        'robustness/evaluation_sets/pietrolesci/nli_fever/dev.csv': {'evaluation': 'fever', 'gold_key': 'label', 'type': 'none', 'subset': 'none', 'metric': 'accuracy', 'pred_label_map': {'entailment': 0, 'contradiction':2, 'neutral': 1}},
        }
