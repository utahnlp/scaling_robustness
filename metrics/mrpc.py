...
from scorer import AccuracyScorer, F1Scorer, AucMRPC
from metrics_utils import extract_model_details, write_list_of_dicts_as_csv
from copy import deepcopy
import pickle

FILE_NAME_TO_METRIC_DETAILS = {
        '/uufs/chpc.utah.edu/common/home/u1266434/scr/robustness/t5_robustness/robustness/paws/paws_wiki_labeled_final/test.tsv': {'evaluation': 'paws-wiki', 'gold_key': 'label', 'type': None, 'subset': None, 'metric': 'mrpc_auc,accuracy', 'gold_label_map': {'0': 'not_equivalent', '1': 'equivalent'}},

        'robustness/evaluation_sets/mrpc/mrpc_validation.csv': {'evaluation': 'mrpc', 'gold_key': 'label', 'type': None, 'subset': None, 'metric': 'accuracy,f1', 'pred_label_map':{'not_equivalent':0, 'equivalent': 1}, },
        }
