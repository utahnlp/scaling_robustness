...
FILE_NAME_TO_METRIC_DETAILS = {
        ...
        'robustness/evaluation_sets/yelp_polarity/imdb_test.csv': {'evaluation': 'imdb', 'gold_key': 'label', 'type': 'none', 'subset': 'none', 'metric': 'accuracy', 'pred_label_map' :{'1': 1, '2': 2}},
        ...
        'robustness/evaluation_sets/yelp_polarity/sst2_validation.csv': {'evaluation': 'sst2', 'gold_key': 'label', 'type': 'none', 'subset': 'none', 'metric': 'accuracy', 'pred_label_map' :{'1': 1, '2': 2}},


        'robustness/evaluation_sets/yelp_polarity/yelp_polarity_test.csv': {'evaluation': 'yelp', 'gold_key': 'label', 'type': 'none', 'subset': 'none', 'metric': 'accuracy', 'pred_label_map' :{'1': 1, '2': 2}},
