...
echo "train_dataset,model_name,model_full_name,params,seed,eval_dataset,category,sub_category,score,metric" >> $results_file
...
do
    ...
    do
        ...
        python mnli_scorer_2.py $EVALUATIONS_DIR $results_file
    done
done
