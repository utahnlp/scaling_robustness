...
FILE_NAME_TO_METRIC_DETAILS = {
        'robustness/evaluation_sets/qnli/qnli_validation.csv': {'evaluation': 'qnli', 'gold_key': 'label', 'type': 'none', 'subset': 'none', 'metric': 'accuracy'},

        'robustness/evaluation_sets/qnli/addSent_qnli.jsonl': {'evaluation': 'adversarial squad', 'gold_key': 'label', 'type': 'none', 'subset': 'none', 'metric': 'accuracy'},
        }
