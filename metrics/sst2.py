...
FILE_NAME_TO_METRIC_DETAILS = {
        ...
        'robustness/evaluation_sets/sst2/c-imdb_paired.tsv': {'evaluation': 'c-imdb', 'gold_key': 'label', 'type': 'none', 'subset': 'none', 'metric': 'accuracy', 'pred_label_map' :{'negative': 'Negative', 'positive': 'Positive',}},

        'robustness/evaluation_sets/sst2/gardner_imdb_test_original.tsv': {'evaluation': 'imdb contrast', 'gold_key': 'Sentiment', 'type': 'none', 'subset': 'original', 'metric': 'accuracy', 'pred_label_map' :{'negative': 'Negative', 'positive': 'Positive'}},

        'robustness/evaluation_sets/sst2/gardner_imdb_test_contrast.tsv': {'evaluation': 'imdb contrast', 'gold_key': 'Sentiment', 'type': 'none', 'subset': 'contrast', 'metric': 'accuracy', 'pred_label_map' :{'negative': 'Negative', 'positive': 'Positive'}},

        'robustness/evaluation_sets/sst2/imdb_test.csv': {'evaluation': 'imdb', 'gold_key': 'label', 'type': 'none', 'subset': 'none', 'metric': 'accuracy'},

        'robustness/evaluation_sets/sst2/rotten_tomatoes_validation.csv': {'evaluation': 'rotten_tomatoes', 'gold_key': 'label', 'type': 'none', 'subset': 'none', 'metric': 'accuracy'},

        'robustness/evaluation_sets/sst2/sst2_validation.csv': {'evaluation': 'sst2', 'gold_key': 'label', 'type': 'none', 'subset': 'none', 'metric': 'accuracy'},


        'robustness/evaluation_sets/sst2/yelp_polarity_test.csv': {'evaluation': 'yelp', 'gold_key': 'label', 'type': 'none', 'subset': 'none', 'metric': 'accuracy'},

        'robustness/evaluation_sets/sst2/amazon_reviews_appliances_beauty_fashion_gift_cards_magazines_software_10000_evaluation.jsonl': {'evaluation': 'amazon_reviews', 'gold_key': 'label', 'type': 'none', 'subset': 'none', 'metric': 'accuracy', 'pred_label_map' :{'negative': 'negative', 'positive': 'positive'}}
        }
